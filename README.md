...
- I'm currently learning and building with the **MERN stack** step by step • Practicing by making small projects from courses and self-practice • Focusing on **clean UI**, **real-world features**, and **problem solving**
- I Build responsive and fast websites • Create modern UI with clean design • Turn ideas into real web apps
...
- Front-end development using **HTML, CSS, Tailwindcss, JavaScript, React, React Router**
- Backend development using **Node.js, Express.js**
- Database using **MongoDB (and Mongoose)**
- Tools like **Git & GitHub, VS Code, npm, Vercel, Netlify, Surge, cloudflare, etc**
- OS using **Ubuntu, Windows**
- Currently exploring **Next.js (and more MERN best practices)**
